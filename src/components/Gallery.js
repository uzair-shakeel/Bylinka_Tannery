    ...
    <div className="px-[4%] py-6">
      ...
      <div className="space-y-4">
        <div className="flex  gap-4">
          <div className="w-[400px] cursor-pointer hover:w-[800px] duration-500 overflow-hidden rounded-3xl h-[250px]">
            <img
        ...
        <div className="flex  gap-4">
          <div className="w-[400px] cursor-pointer hover:w-[800px] duration-500 overflow-hidden rounded-3xl h-[300px]">
            <img
        ...
        <div className="flex  gap-4">
          <div className="w-[400px] cursor-pointer hover:w-[800px] duration-500 overflow-hidden rounded-3xl h-[200px]">
            <img
