  ...
  return (
    <div className="pb-4 md:pb-14 px-[5%]">
      <h1 className="text-2xl md:text-3xl font-bold py-5 text-center">
        Characteristics of Reindeer Skins
      </h1>
      <p className="leading-6 md:leading-8 py-3 text-justify text-tiny md:text-md">
        Reindeer skins are exceptionally resistant to low temperatures and
      ...
      <h1 className="text-2xl md:text-3xl font-bold py-5 text-center">
        Applications of Reindeer Skins
      </h1>
      <p className="leading-6 md:leading-8 py-3 text-justify text-tiny md:text-md">
        Tanned reindeer skins from Bylinka Tannery find wide application both in
      ...
      <p className="leading-6 md:leading-8 py-3 text-justify text-tiny md:text-md">
        Thanks to our commitment to preserving tradition and innovation in
      ...
      <p className="leading-6 md:leading-8 py-3 text-justify text-tiny md:text-md">
        Each skin is carefully selected and manually cleaned to remove any
        impurities. This stage is crucial to preserve the natural properties of
        the reindeer skin.
      </p>
      <p className="leading-6 md:leading-8 py-3 text-justify text-tiny md:text-md">
        We use a specially developed tanning method that enhances the natural
      ...
      <p className="leading-6 md:leading-8 py-3 text-justify text-tiny md:text-md">
        The skins are gently dyed to highlight their natural color while
